...
def overplot_covar(fig, xs, covars, sigma=1, reverse=False, **kwargs):
    """
    Overplot covariance ellipse on a figure generated by ``corner.corner``
    ...
    covs : array_like[nsamples, ndim, ndim]
        ...
        for k1 in range(K):
            for k2 in range(k1):
                ...
                for i in range(K):
                    ...
                    axes[K - k1 - 1, K - k2 - 1].add_artist(ellipse)
